...
export function CategoryChart({ data }: { data: CategoryMetric[] }) {
  ...
  const option = {
    ...
    yAxis: { type: "category", data: sorted.map((c) => categoryLabelRu(c.category)), axisTick: { show: false } },
  ...
  return (
    <div className="card p-4">
      <h3 className="mb-2 text-sm font-semibold">Доля выручки по категориям</h3>
