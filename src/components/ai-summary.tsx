  ...
  return (
    <div className="card p-5">
      ...
      <div className="mt-4 space-y-3 text-sm">
        <div>
          <p className="text-xs uppercase tracking-wide text-muted">Weekly Summary</p>
          <p className="mt-1">{data.weekly_summary}</p>
        </div>
        <div>
          <p className="text-xs uppercase tracking-wide text-muted">Key Risk</p>
          <p className="mt-1 text-rose-700">{data.key_risk}</p>
        </div>
        <div>
          <p className="text-xs uppercase tracking-wide text-muted">Key Opportunity</p>
